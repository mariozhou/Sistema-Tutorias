                        ...
                        <td>
                            ...
                            <div class="container">
                                <div class="row align-items-start">
                                    ...
                                    <div class="col">
                                        <a class="btn btn-primary" target="_black" href="<?php echo 'http://' . $_SERVER['HTTP_HOST'] . '/Sistema-Tutoria/' . $val['url']; ?>" >Ver Archivo pagina</a>
                                    </div>
                                </div>
                            </div>    
    ...
    <div class="container">
        ...
        <script>
                            ...
                            function openModelPDF(url) {
                                $('#modalPdf').modal('show');
                                $('#iframePDF').attr('src','<?php echo 'http://' . $_SERVER['HTTP_HOST'] . '/Sistema-Tutoria/'; ?>'+url);
                            }
        </script>
       </div>
</div>
