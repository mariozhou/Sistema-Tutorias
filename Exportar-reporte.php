...
$sentenciaSQL1 = $conexion->prepare("SELECT tutorados.NombreTutorado, reporte.IdTutorado, reporte.HoraSesionIndiv, 
reporte.HoraSesionGrup, reporte.EvaValor, reporte.EvalNivel FROM tutorados 
